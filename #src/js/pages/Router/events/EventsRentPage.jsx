...
import {
	SectionEventsRent
} from '../../../components/categories/events/SectionEventsRent.jsx';
				...
				<div className="main-content" id="wrapper">
					<div className="main-content__content" id="content">
						<section className="main-content__body">
							<SectionEventsRent baseUrl={baseUrl} isHomePage={true} />
						</section>
