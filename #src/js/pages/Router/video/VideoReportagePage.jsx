...
import {
	SectionVideoReportage
} from '../../../components/categories/video/SectionVideoReportage.jsx';
				...
				<div className="main-content" id="wrapper">
					<div className="main-content__content" id="content">
						<section className="main-content__body">
							<SectionVideoReportage baseUrl={baseUrl} isHomePage={true} />
						</section>
...
export default VideoReportagePage;