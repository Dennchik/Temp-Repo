...
import {
	SectionVideoDesign
} from '../../../components/categories/video/SectionVideoDesign.jsx';
				...
				<div className="main-content" id="wrapper">
					<div className="main-content__content" id="content">
						<section className="main-content__body">
							<SectionVideoDesign baseUrl={baseUrl} isHomePage={true} />
						</section>
...
export default VideoDesignPage;