						...
						<div className="service-description__description">
							<div className="service-description__row">
								<div className="service-description__row-col">
									<p><i className="icon-volume-high _icon"></i>Самой
										востребованной услугой в студии является запись голоса.
										Сегодня мы подробнее расскажем о&nbsp;ней. Вы включаете
										радио и слышите идеально записанные голоса, четкие
										попадания
										в&nbsp;ноты и&nbsp;потрясающий вокал. Этого звучания
										можно
										добиться при записи в&nbsp;профессиональной студии.
									</p>
									<p><i className="icon-volume-high _icon"></i>Когда вы
										приходите в студию, вы платите деньги
										за&nbsp;определенные
										вещи. Например, за дорогостоящее оборудование
										и&nbsp;опыт
										профессионалов. Вам гораздо проще и&nbsp;удобнее прийти
										в&nbsp;студию, записать свой голос и&nbsp;быстро
										получить
										...
										за&nbsp;запись и&nbsp;обработку вашего голоса
										в&nbsp;студии,
								...
								<div className="service-description__row-col">
									<p><i className="icon-volume-high _icon"></i>Атмосфера
										...
										пользоваться и&nbsp;направлять свое эмоциональное
										состояние
										в нужное русло. Да, вы будете волноваться, стоя
										в&nbsp;вокальной комнате перед микрофоном, но&nbsp;скоро
										вы
										освоитесь и&nbsp;поймете, какая на&nbsp;самом деле
										непринужденная обстановка царит в&nbsp;студии
										звукозаписи.
									</p>
									<p><i className="icon-volume-high _icon"></i>Вы платите
										исключительно за&nbsp;время работы на&nbsp;студии. Сюда
										входят все виды работ. Неважно, это&nbsp;сведение,
										мастеринг
